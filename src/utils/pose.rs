...
mod tests {
    ...
    #[test]
    fn test_adjacent() {
        let pose = Pose::new(Vector::new(5, 5), Orientation::North);
        let adjacent = pose.adjacent();
    ...
    fn test_move_forward() {
        let mut pose = Pose::new(Vector::new(0, 0), Orientation::North);
        pose.move_forward(3);
        assert_eq!(pose.position, Vector::new(0, -3));

        let mut pose = Pose::new(Vector::new(0, 0), Orientation::East);
        pose.move_forward(5);
    ...
    fn test_move_backward() {
        ...
        let mut pose = Pose::new(Vector::new(0, 0), Orientation::West);
    ...
    fn test_move_right() {
        ...
        let mut pose = Pose::new(Vector::new(0, 0), Orientation::South);
        pose.move_right(5);
        assert_eq!(pose.position, Vector::new(-5, 0));
    }
